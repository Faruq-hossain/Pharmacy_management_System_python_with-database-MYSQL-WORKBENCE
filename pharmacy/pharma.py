...
class PharmacyManagementSyatem:
    def __init__(self, root):
        ...
        img1 = Image.open("C:\\Users\\FARUQ\\Desktop\\pharmacy\\logo.png")
        ...
        DataFrameLeft = LabelFrame(DataFrame, bd=10, relief=RIDGE, padx=20,
                                   text="Medicine Informantion", fg="darkgreen", font=("arial", 12, "bold"))
        ...
        btnResetMed = Button(ButtonFrame, command=self.reset, text="Reset", font=(
            "arial", 13, "bold"), width=14, bg="darkgreen", fg="white")
        ...
        lblSearch = Label(ButtonFrame, font=("arial", 17, "bold"),
                          text="Search By", padx=2, bg="darkred", fg="white")
        ...
        search_combo = ttk.Combobox(
            ButtonFrame, textvariable=self.search_var, width=12, font=("arial", 16, "bold"), state="readonly")
        search_combo.grid(row=0, column=6)
        search_combo["values"] = ("refno", "medname", "Iot")
        search_combo.grid(row=0, column=6)
        search_combo.current(0)

        self.searchTxt_var = StringVar()

        txtSearch = Entry(ButtonFrame, textvariable=self.searchTxt_var, bd=3, relief=RIDGE,
                          width=15, font=("arial", 13, "bold"))
        ...
        showAll = Button(ButtonFrame,command=self.fetch_data, text="Show All", font=(
            "arial", 13, "bold"), width=14, bg="darkgreen", fg="white")
        ...
        conn = mysql.connector.connect(
            host="localhost", username="root", password="Iloveuallah1*", database="mydata")
        my_cursor = conn.cursor()
        my_cursor.execute("select Ref from pharma")
        r = my_cursor.fetchall()

        lblerfno = Label(DataFrameLeft, font=("arial", 12, "bold"),
                         text="Referenec No", padx=2, pady=6)
        lblerfno.grid(row=0, column=0, sticky=W)

        comrefno = ttk.Combobox(
            DataFrameLeft, textvariable=self.ref_var, width=27, font=("arial", 12, "bold"), state="readonly")
        ...
        comTypeofMedicine = ttk.Combobox(
            DataFrameLeft, textvariable=self.typeMed_var, width=27, font=("arial", 12, "bold"), state="readonly")
        # ref_combo.grid(row=0, column=6)
        comTypeofMedicine["value"] = (
            "Tablet", "Liquid", "Capsules", "Topical", "Drops", "Inhales", "Injection")
        ...
        comMedicineName = ttk.Combobox(
            DataFrameLeft, textvariable=self.medName_var, width=27, font=("arial", 12, "bold"), state="readonly")
        # ref_combo.grid(row=0, column=6)
        ...
        lblPriceWarning = Label(DataFrameLeft, font=(
            "arial", 12, "bold"), text="Price&Warning:", padx=15, pady=6)
        lblPriceWarning.grid(row=0, column=2, sticky=W)
        txtPriceWarning = Entry(DataFrameLeft, textvariable=self.warning_var, font=(
            "arial", 12, "bold"), bg="white", bd=2, relief=RIDGE, width=29)
        txtPriceWarning.grid(row=0, column=3)
        ...
        lblPrice = Label(DataFrameLeft, font=(
            "arial", 12, "bold"), text="Price:", padx=15, pady=6)
        ...
        lblhome = Label(DataFrameLeft, font=(
            "arial", 15, "bold"), text="Stay Home Stay Safe", padx=2, pady=6, bg="white", fg="red", width=37)
        lblhome.place(x=410, y=135)

        img2 = Image.open("C:\\Users\\FARUQ\\Desktop\\pharmacy\\lab2.jfif")
        ...
        img3 = Image.open("C:\\Users\\FARUQ\\Desktop\\pharmacy\\lab.jfif")
        ...
        img4 = Image.open("C:\\Users\\FARUQ\\Desktop\\pharmacy\\lab3.jfif")
        ...
        img5 = Image.open("C:\\Users\\FARUQ\\Desktop\\pharmacy\\tablet.jfif")
        img5 = img4.resize((200, 75), Image.ANTIALIAS)
        self.photoimg5 = ImageTk.PhotoImage(img5)
        b1 = Button(self.root, image=self.photoimg5, borderwidth=0)
        b1.place(x=960, y=160)

        img6 = Image.open("C:\\Users\\FARUQ\\Desktop\\pharmacy\\tablet2.jfif")
        ...
        img7 = Image.open("C:\\Users\\FARUQ\\Desktop\\pharmacy\\lab.jfif")
        ...
        lblrefno = Label(DataFrameRight, font=(
            "arial", 12, "bold"), text="Reference No:")
        lblrefno.place(x=0, y=80)
        txtrefno = Entry(DataFrameRight, textvariable=self.refMed_var, font=(
            "arial", 15, "bold"), bg="white", bd=2, relief=RIDGE, width=14)
        txtrefno.place(x=135, y=80)

        lblmedicineName = Label(DataFrameRight, font=(
            "arial", 12, "bold"), text="Medicine Name:")
        lblmedicineName.place(x=0, y=110)
        txtmedicineName = Entry(DataFrameRight, textvariable=self.addmed_var, font=(
            "arial", 15, "bold"), bg="white", bd=2, relief=RIDGE, width=14)
        ...
        # ===========Mediicine Add Button===================

        down_frame = Frame(DataFrameRight, bd=4, relief=RIDGE, bg="darkgreen")
        down_frame.place(x=330, y=150, width=135, height=160)

        btnAddmed = Button(down_frame, command=self.AddMed, text="Add", font=(
            "arial", 12, "bold"), width=12, bg="lime", fg="white", pady=4)
        btnAddmed.grid(row=0, column=0)

        btnUpdatemed = Button(down_frame, command=self.UpdateMed, text="Update", font=(
            "arial", 12, "bold"), width=12, bg="purple", fg="white", pady=4)
        btnUpdatemed.grid(row=1, column=0)

        btnDeletemed = Button(down_frame, command=self.DeleteMed, text="Delete", font=(
            "arial", 12, "bold"), width=12, bg="red", fg="white", pady=4)
        btnDeletemed.grid(row=2, column=0)

        btnClearmed = Button(down_frame, command=self.ClearMed, text="Clear", font=(
            "arial", 12, "bold"), width=12, bg="orange", fg="white", pady=4)
        ...
        self.pharmacy_table.heading("tabletname", text="Type of Medicine")
    ...
    # ================ MedGetCourser data box e show kora==================
    ...
    def Update_data(self):
        if self.ref_var.get() == "":
            ...
            conn = mysql.connector.connect(
                host="localhost", username="root", password="Iloveuallah1*", database="mydata")
            my_cursor = conn.cursor()
            my_cursor.execute("update pharmacy set cmpName=%s,Type=%s,medname=%s,Iot=%s,issuedate=%s,expdate=%s,uses=%s,sideeffect=%s,warning=%s,dosge=%s,price=%s,product=%s where refno=%s", (
    ...
    def delete(self):
        ...
        messagebox.showinfo("Delete", "Information deleteed successfully")
    ...
    def search_data(self):
        ...
        my_cursor.execute("select * from pharmacy where " +
                          str(self.search_var.get())+"LIKE"+str(self.searchTxt_var.get())+"%")
